...
> => {
  return {
    ...
    textSelectionColor: "#111111",
    textSelectionTagColor: "#a8a8a8",
    textLineLinks: [],
    ...
    preciseMeasurement: null,
    gridCharTopMeasurement: null,
    userToFollow: null,
    followedBy: new Set(),
    isCropping: false,
...
>(config: { [K in keyof T]: K extends keyof AppState ? T[K] : never }) =>
  ...
  fileSize: { browser: false, export: false, server: false },
  ...
  textSelectionColor: { browser: true, export: false, server: false },
  textSelectionTagColor: { browser: true, export: false, server: false },
  ...
  isToolbarVisible: { browser: true, export: false, server: false },
  areExtraButtonsVisible: { browser: true, export: false, server: false },
  areUselessButtonsHidden: { browser: true, export: false, server: false },
  ...
  preciseMeasurement: { browser: false, export: false, server: false },
  gridCharTopMeasurement: { browser: false, export: false, server: false },
